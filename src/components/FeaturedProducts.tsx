...
export default function FeaturedProducts() {
  ...
  return (
    <section className="py-16 md:py-24 border-t border-slate-200/80 bg-slate-50/40">
      <div className="max-w-7xl mx-auto px-6 lg:px-20">
        <div className="text-center mb-12 max-w-2xl mx-auto">
          <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-500 mb-3">Highlights</p>
          <h2 className="text-2xl md:text-3xl font-heading font-semibold text-slate-900 tracking-tight mb-4">
            Featured products
          </h2>
          <p className="text-slate-600 leading-relaxed">
            A short selection of assemblies and components we regularly supply. See the full catalogue on the products page.
          </p>
        </div>
                ...
                <div key={product.id} className="w-full flex-shrink-0 px-4">
                  <Card className="overflow-hidden border-slate-200/90 shadow-md">
                    <div className="grid md:grid-cols-2 gap-0 md:gap-6">
                      <div className="aspect-[4/3] md:min-h-[320px] bg-slate-100">
                        <img
                          src={product.image}
                          alt={product.name}
                          loading="lazy"
                      ...
                      <CardContent className="p-6 md:p-8 flex flex-col justify-center bg-white">
                        <h3 className="text-xl md:text-2xl font-heading font-semibold text-slate-900 mb-5" data-testid={`text-featured-${product.id}`}>
                          {product.name}
                        </h3>
